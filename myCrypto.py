...
#LSB FIRST???
	...
	bmessage=bmessage.ljust(length+1,'1').ljust(448,'0')+blength
	...
	X=[hmessage[i:i+8] for i in range(0, len(hmessage)-1, 8)]
	...
	hex_data1 =(Af<<128)+(Bf<<96)+(Cf<<64)+(Df<<32)+Ef
	answer=hex(hex_data1)[2:-1]
