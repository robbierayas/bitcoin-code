...
print ''
print 'Method 3'
pkHashStep21=myCrypto.myRipeMD160('')
print 'MyTransaction pkHashStep21 {}'.format(pkHashStep21)
pkHashStep22=utils.base58CheckEncode(0,pkHashStep21) 


print 'MyTransaction pkHashStep22 calculated from ripemd160 func base58(RIPEMD160(SHA256(PK))) {}'.format(pkHashStep22)
