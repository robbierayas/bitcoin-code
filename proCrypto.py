...
print 'Xne'
data = RIPEMD160('a2d43efac7e99b7e3cf4c07ebfebb3c349d8f2b5b0e1062d9cef93c170d22d4f')
print 'data {}'.format(data)
print 'data.decode() {}'.format(data.decode('hex'))
pkHashStep22=utils.base58CheckEncode(0,data.decode('hex')) 
print 'pkHashStep22 {}'.format(pkHashStep22)
print data,data =='f3cd5ddd30ad4d28f13cf195786f2e95e8914b22'   # its always false